...
public class ApocalypseMultiplierCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher().register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.m_82127_("WariumApocalypseMultiplier").requires((s) -> {
         return s.m_6761_(4);
      })).then(Commands.m_82129_("multiplier", DoubleArgumentType.doubleArg(0.0D, 64.0D)).executes((arguments) -> {
