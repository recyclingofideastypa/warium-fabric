      ...
      if (immediatesourceentity != null) {
         ...
         if (!immediatesourceentity.getPersistentData().m_128471_("Used")) {
            for(int index0 = 0; index0 < 35; ++index0) {
               world.m_7106_((SimpleParticleType)CrustyChunksModParticleTypes.SPLASH_PUFF.get(), x + Mth.m_216263_(RandomSource.m_216327_(), -0.5D, 1.5D), y + Mth.m_216263_(RandomSource.m_216327_(), -0.5D, 2.5D), z + Mth.m_216263_(RandomSource.m_216327_(), -0.5D, 1.5D), Mth.m_216263_(RandomSource.m_216327_(), -1.5D, 1.5D), Mth.m_216263_(RandomSource.m_216327_(), -0.1D, 0.8D), Mth.m_216263_(RandomSource.m_216327_(), -1.5D, 1.5D));
            }
