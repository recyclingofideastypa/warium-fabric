      ...
      if (entity != null) {
         if (itemstack.m_41784_().m_128471_("action")) {
            ...
            if (entity instanceof Player) {
               ...
               _player.m_36335_().m_41524_(itemstack.m_41720_(), 4);
            }
            ...
            CrustyChunksMod.queueServerWork(1, () -> {
               if (world instanceof Level) {
                  ...
                  if (!_level.m_5776_()) {
                     _level.m_5594_((Player)null, BlockPos.m_274561_(x, y, z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:pistolaction")), SoundSource.PLAYERS, 1.0F, 1.0F);
                  } else {
                     _level.m_7785_(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:pistolaction")), SoundSource.PLAYERS, 1.0F, 1.0F, false);
                  }
               }
