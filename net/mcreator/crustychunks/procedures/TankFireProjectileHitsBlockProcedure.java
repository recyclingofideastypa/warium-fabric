   ...
   public static void execute(LevelAccessor world, Entity immediatesourceentity) {
      if (immediatesourceentity != null) {
         ...
         if (world instanceof Level) {
            ...
            if (!_level.m_5776_()) {
               _level.m_254849_((Entity)null, immediatesourceentity.m_20185_(), immediatesourceentity.m_20186_(), immediatesourceentity.m_20189_(), 6.0F, ExplosionInteraction.NONE);
            }
         }
