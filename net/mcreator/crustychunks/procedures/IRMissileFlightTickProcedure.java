   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity immediatesourceentity) {
      if (immediatesourceentity != null) {
         ...
         if (immediatesourceentity.getPersistentData().m_128459_("Time") <= 130.0D) {
            ...
            _center = immediatesourceentity.m_20184_().m_82490_(1.01D);
         ...
         List<Entity> _entfound = world.m_6443_(Entity.class, (new AABB(_center, _center)).m_82400_(300.0D), (e) -> {
            return true;
         ...
         while(true) {
            ...
            do {
               if (!var29.hasNext()) {
                  if (speed > 12.0D && 10.0D < immediatesourceentity.getPersistentData().m_128459_("Time")) {
            ...
            if (Math.sqrt(Math.pow(entityiterator.m_20186_() - y, 2.0D) + Math.pow(entityiterator.m_20185_() - x, 2.0D) + Math.pow(entityiterator.m_20189_() - z, 2.0D)) - Math.sqrt(Math.pow(entityiterator.m_20186_() - (y + immediatesourceentity.m_20184_().m_7098_()), 2.0D) + Math.pow(entityiterator.m_20185_() - (x + immediatesourceentity.m_20184_().m_7096_()), 2.0D) + Math.pow(entityiterator.m_20189_() - (z + immediatesourceentity.m_20184_().m_7094_()), 2.0D)) > 1.25D) {
