   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         ...
         if (1 == Mth.m_216271_(RandomSource.m_216327_(), 1, 400)) {
            entity.getPersistentData().m_128379_("SuppressiveFire", !entity.getPersistentData().m_128471_("SuppressiveFire"));
         }

         if (1 == Mth.m_216271_(RandomSource.m_216327_(), 1, 40) && world.m_6106_().m_5470_().m_46207_(CrustyChunksModGameRules.APOCALYPSE_MODE) && entity.m_20184_().m_7096_() != 0.0D && entity.m_20184_().m_7094_() != 0.0D) {
         ...
         if (var10000 != null) {
            ...
            if (Mth.m_216271_(RandomSource.m_216327_(), 1, 5) == 1) {
               ...
               double var17 = var10004.m_20185_();
               ...
               double var18 = var10005.m_20186_() + 1.0D;
               ...
               var10002.<init>(var17, var18, var10006.m_20189_());
               ...
               if (var16 > 0.0F) {
                  label136: {
                     ...
                     label114: {
                        ...
                        if (!entity.getPersistentData().m_128471_("SuppressiveFire")) {
                           break label136;
                        }
                     }
         ...
         if (entity.getPersistentData().m_128459_("Cycle") > 0.0D) {
            ...
            if (world instanceof Level) {
               ...
               if (!_level.m_5776_()) {
                  _level.m_5594_((Player)null, BlockPos.m_274561_(x, y, z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:strikerstep")), SoundSource.NEUTRAL, 4.0F, (float)Mth.m_216263_(RandomSource.m_216327_(), 0.7D, 0.8D));
               } else {
                  _level.m_7785_(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:strikerstep")), SoundSource.NEUTRAL, 4.0F, (float)Mth.m_216263_(RandomSource.m_216327_(), 0.7D, 0.8D), false);
               }
            }
         }
