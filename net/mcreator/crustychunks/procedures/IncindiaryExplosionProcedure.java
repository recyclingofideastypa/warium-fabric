   ...
   public static void execute(LevelAccessor world, double x, double y, double z) {
      ...
      if (world.m_6425_(BlockPos.m_274561_(x, y + 1.0D, z)).m_76188_().m_60734_() instanceof LiquidBlock) {
         if (world instanceof Level) {
            _level = (Level)world;
            if (!_level.m_5776_()) {
               _level.m_254849_((Entity)null, x, y, z, 2.0F, ExplosionInteraction.MOB);
            }
         }
         ...
         _entityToSpawn.m_6686_(0.0D, 1.0D, 0.0D, (float)Mth.m_216263_(RandomSource.m_216327_(), 0.5D, 0.7D), 90.0F);
      ...
      ServerLevel _level;
      int index3;
      for(index3 = 0; index3 < 275; ++index3) {
         if (world instanceof ServerLevel) {
            ...
            })).getArrow(_level, 11.0F, 3, (byte)2);
            _entityToSpawn.m_6034_(x, y + 1.0D, z);
            _entityToSpawn.m_6686_(0.0D, 1.0D, 0.0D, (float)Mth.m_216263_(RandomSource.m_216327_(), 0.7D, 0.8D), 90.0F);
            _level.m_7967_(_entityToSpawn);
         }
      }

      for(index3 = 0; index3 < 20; ++index3) {
         if (world instanceof ServerLevel) {
            _level = (ServerLevel)world;
            _entityToSpawn = ((<undefinedtype>)(new Object() {
               public Projectile getArrow(Level level, float damage, int knockback, byte piercing) {
      ...
      for(index3 = 0; index3 < 25; ++index3) {
         if (world instanceof ServerLevel) {
            _level = (ServerLevel)world;
            FallingBlockEntity.m_201971_(_level, BlockPos.m_274561_(x, y + 3.0D, z), Blocks.f_50083_.m_49966_());
         }
      }
