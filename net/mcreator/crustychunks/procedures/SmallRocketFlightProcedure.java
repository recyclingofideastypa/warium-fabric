...
public class SmallRocketFlightProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity immediatesourceentity) {
      if (immediatesourceentity != null) {
         ...
         if (immediatesourceentity.getPersistentData().m_128459_("Time") <= 60.0D) {
            ...
            if (immediatesourceentity.getPersistentData().m_128459_("Time") / 10.0D == (double)Math.round(immediatesourceentity.getPersistentData().m_128459_("Time") / 10.0D) && world instanceof Level) {
               Level _level = (Level)world;
               if (!_level.m_5776_()) {
                  _level.m_5594_((Player)null, BlockPos.m_274561_(x, y, z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.fire.extinguish")), SoundSource.NEUTRAL, 3.0F, (float)Mth.m_216263_(RandomSource.m_216327_(), 0.8D, 1.0D));
               } else {
                  _level.m_7785_(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.fire.extinguish")), SoundSource.NEUTRAL, 3.0F, (float)Mth.m_216263_(RandomSource.m_216327_(), 0.8D, 1.0D), false);
               }
            }
