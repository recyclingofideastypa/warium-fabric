...
public class LargeFlakProjectileWhileProjectileFlyingTickProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity immediatesourceentity) {
      if (immediatesourceentity != null) {
         ...
         world.m_7106_((SimpleParticleType)CrustyChunksModParticleTypes.LARGE_BULLET_TRAIL.get(), x, y, z, immediatesourceentity.m_20184_().m_7096_() * 0.1D, immediatesourceentity.m_20184_().m_7098_() * 0.1D, immediatesourceentity.m_20184_().m_7094_() * 0.1D);
         if (world.m_8055_(BlockPos.m_274561_(x, y, z)).m_60734_() instanceof LiquidBlock) {
            trigger = true;
         }
         ...
         List<Entity> _entfound = world.m_6443_(Entity.class, (new AABB(_center, _center)).m_82400_(10.0D), (e) -> {
            return true;
