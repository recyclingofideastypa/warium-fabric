      ...
      if (entity != null) {
         ...
         CrustyChunksMod.queueServerWork(60, () -> {
            for(int index0 = 0; index0 < 3; ++index0) {
               ...
               if (world instanceof ServerLevel) {
                  _level = (ServerLevel)world;
                  entityToSpawnx = new ItemEntity(_level, x + 0.5D, y + 1.0D, z + 0.5D, new ItemStack((ItemLike)CrustyChunksModItems.PETROLIUM_BUCKET.get()));
                  entityToSpawnx.m_32010_(10);
                  _level.m_7967_(entityToSpawnx);
               }
            ...
            if (world instanceof ServerLevel) {
               ...
               ItemEntity entityToSpawn = new ItemEntity(_levelx, x + 0.5D, y + 1.0D, z + 0.5D, new ItemStack((ItemLike)CrustyChunksModItems.FLAME_THROWER_ANIMATED.get()));
