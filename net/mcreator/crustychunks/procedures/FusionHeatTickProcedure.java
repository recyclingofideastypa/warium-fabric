         ...
         if (immediatesourceentity.getPersistentData().m_128459_("T") <= 20.0D) {
            ...
            for(int index0 = 0; index0 < 200; ++index0) {
               ...
               if (1 == Mth.m_216271_(RandomSource.m_216327_(), 1, 40)) {
                  ...
                  world.m_7106_((SimpleParticleType)CrustyChunksModParticleTypes.DEATH_RAY.get(), x + immediatesourceentity.m_20154_().f_82479_ * 15.0D, y + immediatesourceentity.m_20154_().f_82480_ * 15.0D, z + immediatesourceentity.m_20154_().f_82481_ * 15.0D, immediatesourceentity.m_20154_().f_82479_, immediatesourceentity.m_20154_().f_82480_, immediatesourceentity.m_20154_().f_82481_);
                  ...
                  world.m_7106_((SimpleParticleType)CrustyChunksModParticleTypes.DEATH_RAY.get(), x + immediatesourceentity.m_20154_().f_82479_ * 25.0D, y + immediatesourceentity.m_20154_().f_82480_ * 25.0D, z + immediatesourceentity.m_20154_().f_82481_ * 25.0D, immediatesourceentity.m_20154_().f_82479_, immediatesourceentity.m_20154_().f_82480_, immediatesourceentity.m_20154_().f_82481_);
                  world.m_7106_((SimpleParticleType)CrustyChunksModParticleTypes.DEATH_RAY.get(), x + immediatesourceentity.m_20154_().f_82479_ * 30.0D, y + immediatesourceentity.m_20154_().f_82480_ * 30.0D, z + immediatesourceentity.m_20154_().f_82481_ * 30.0D, immediatesourceentity.m_20154_().f_82479_, immediatesourceentity.m_20154_().f_82480_, immediatesourceentity.m_20154_().f_82481_);
               }
            }
         } else {
