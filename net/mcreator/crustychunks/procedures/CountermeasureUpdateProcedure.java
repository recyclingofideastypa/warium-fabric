...
public class CountermeasureUpdateProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
      ...
      })).getValue(world, BlockPos.m_274561_(x, y, z), "Cooldown") > 0.0D && !world.m_5776_()) {
      ...
      if (0.0D < ((<undefinedtype>)var10001).getValue(world, var10003, "Trigger" + var10004) && !world.m_5776_()) {
         ...
         if (_blockEntity != null) {
            ...
            BlockPos var20 = BlockPos.m_274561_(((<undefinedtype>)(new Object() {
               public double getValue(LevelAccessor world, BlockPos pos, String tag) {
                  BlockEntity blockEntity = world.m_7702_(pos);
                  return blockEntity != null ? blockEntity.getPersistentData().m_128459_(tag) : -1.0D;
               }
            ...
            var10000.m_128347_("Trigger", ((<undefinedtype>)var10002).getValue(world, var20, "Trigger" + var10005));
         }
