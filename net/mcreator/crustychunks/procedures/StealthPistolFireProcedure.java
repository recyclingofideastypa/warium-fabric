            ...
            if (!itemstack.m_41784_().m_128471_("action")) {
               ...
               if (1.0D <= itemstack.m_41784_().m_128459_("Ammo")) {
                  if (itemstack.m_41784_().m_128471_("Loaded")) {
                     if (entity.m_6144_()) {
                        if (itemstack.m_41720_() instanceof StealthPistolItem) {
                           itemstack.m_41784_().m_128359_("geckoAnim", "sightfire");
                        }
                     } else if (itemstack.m_41720_() instanceof StealthPistolItem) {
                     ...
                     if (itemstack.m_41784_().m_128461_("Type").equals("AP")) {
                        ...
                        if (!projectileLevel.m_5776_()) {
                           ...
                           _entityToSpawn.m_6686_(entity.m_20154_().f_82479_, entity.m_20154_().f_82480_, entity.m_20154_().f_82481_, 4.0F, (float)Movementinnacuracy);
