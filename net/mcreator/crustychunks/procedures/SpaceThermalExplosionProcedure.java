   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity immediatesourceentity) {
      if (immediatesourceentity != null) {
         ...
         if (immediatesourceentity.getPersistentData().m_128459_("T") <= 20.0D) {
            ...
            _entfound = world.m_6443_(Entity.class, (new AABB(_center, _center)).m_82400_(40.0D), (e) -> {
               return true;
            }).stream().sorted(Comparator.comparingDouble((_entcnd) -> {
               return _entcnd.m_20238_(_center);
            })).toList();
            ...
            while(var33.hasNext()) {
               entityiterator = (Entity)var33.next();
               if (entityiterator != immediatesourceentity && entityiterator.m_6095_().m_204039_(TagKey.m_203882_(Registries.f_256939_, new ResourceLocation("crusty_chunks:projectile"))) && !entityiterator.m_9236_().m_5776_()) {
                  entityiterator.m_146870_();
               }
            }

            immediatesourceentity.getPersistentData().m_128347_("T", immediatesourceentity.getPersistentData().m_128459_("T") + 1.0D);
         } else if (immediatesourceentity.getPersistentData().m_128459_("T") <= 250.0D) {
            immediatesourceentity.getPersistentData().m_128347_("T", immediatesourceentity.getPersistentData().m_128459_("T") + 1.0D);
