   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity immediatesourceentity) {
      if (immediatesourceentity != null) {
         ...
         if (immediatesourceentity.getPersistentData().m_128459_("T") >= 20.0D && world instanceof Level) {
            ...
            if (!_level.m_5776_()) {
               _level.m_5594_((Player)null, BlockPos.m_274561_(x, y, z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.firework_rocket.launch")), SoundSource.NEUTRAL, 3.0F, (float)(3.0D - immediatesourceentity.m_20154_().f_82480_ * 3.0D));
            } else {
               _level.m_7785_(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.firework_rocket.launch")), SoundSource.NEUTRAL, 3.0F, (float)(3.0D - immediatesourceentity.m_20154_().f_82480_ * 3.0D), false);
            }
         }
