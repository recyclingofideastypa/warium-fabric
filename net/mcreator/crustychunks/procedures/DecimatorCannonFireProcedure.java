   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         ...
         if (world instanceof ServerLevel) {
            ...
            _entityToSpawn.m_6034_(x + entity.m_20154_().f_82479_ * 2.0D, y + 2.0D + entity.m_20154_().f_82480_ * 2.0D, z + entity.m_20154_().f_82481_ * 2.0D);
            _entityToSpawn.m_6686_(entity.m_20154_().f_82479_, entity.m_20154_().f_82480_, entity.m_20154_().f_82481_, 6.0F, 2.0F);
         ...
         entity.getPersistentData().m_128347_("T", (double)Mth.m_216271_(RandomSource.m_216327_(), 9, 11));
         Level _level;
