...
public class RocketPodReloadProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         ...
         BlockState _bs;
         if (var10000.m_41720_() == CrustyChunksModItems.ARMOR_PEELER_ROCKET.get()) {
            if (9.0D > ((<undefinedtype>)(new Object() {
               ...
               if (entity instanceof LivingEntity) {
                  ...
                  ItemStack _setstack = (new ItemStack((ItemLike)CrustyChunksModItems.ARMOR_PEELER_ROCKET.get())).m_41777_();
