...
public class RevolverFireScriptProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
      if (entity != null) {
         ...
         recoil = Mth.m_216263_(RandomSource.m_216327_(), 6.0D, 8.0D);
         ...
         if (((CrustyChunksModVariables.PlayerVariables)entity.getCapability(CrustyChunksModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CrustyChunksModVariables.PlayerVariables())).AimDownSights) {
            ...
            if (var10000.m_41720_() == ItemStack.f_41583_.m_41720_()) {
               recoil = Mth.m_216263_(RandomSource.m_216327_(), 4.0D, 6.0D);
         ...
         if (var10000.m_41720_() == ItemStack.f_41583_.m_41720_() && !itemstack.m_41784_().m_128471_("action")) {
            itemstack.m_41784_().m_128379_("action", true);
            if (1.0D <= itemstack.m_41784_().m_128459_("Ammo")) {
               if (((CrustyChunksModVariables.PlayerVariables)entity.getCapability(CrustyChunksModVariables.PLAYER_VARIABLES_CAPABILITY, (Direction)null).orElse(new CrustyChunksModVariables.PlayerVariables())).AimDownSights) {
                  if (itemstack.m_41720_() instanceof RevolverAnimatedItem) {
                     itemstack.m_41784_().m_128359_("geckoAnim", "sightfire");
                  }
               } else if (itemstack.m_41720_() instanceof RevolverAnimatedItem) {
               ...
               entity.m_146922_((float)((double)entity.m_146908_() + Mth.m_216263_(RandomSource.m_216327_(), -2.0D, 2.0D)));
