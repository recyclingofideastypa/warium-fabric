   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity immediatesourceentity) {
      if (immediatesourceentity != null) {
         ...
         if (1.0D == immediatesourceentity.getPersistentData().m_128459_("T")) {
            FissionEffectsProcedure.execute(world, x, immediatesourceentity.m_20186_() - 15.0D, z);
         ...
         for(particleAmount = (double)(1L + Math.round(xRadius)); loop < particleAmount; ++loop) {
            if (immediatesourceentity.getPersistentData().m_128459_("T") / 4.0D == (double)Math.round(immediatesourceentity.getPersistentData().m_128459_("T") / 4.0D)) {
               Level _level;
               if (1 == Mth.m_216271_(RandomSource.m_216327_(), 1, 4)) {
                  ...
                  if (300.0D >= immediatesourceentity.getPersistentData().m_128459_("T")) {
         ...
         if (250.0D <= immediatesourceentity.getPersistentData().m_128459_("T") && !immediatesourceentity.m_9236_().m_5776_()) {
