      ...
      if (entity != null) {
         ...
         if (var10000.m_41613_() == 0) {
            ...
            if (var10001.m_41784_().m_128471_("Loaded")) {
               if (entity instanceof LivingEntity) {
                  _livEnt = (LivingEntity)entity;
                  _setstack = (new ItemStack((ItemLike)CrustyChunksModItems.MEDIUM_MAGAZINE.get())).m_41777_();
                  _setstack.m_41764_(1);
                  _livEnt.m_21008_(InteractionHand.OFF_HAND, _setstack);
               ...
               CrustyChunksMod.queueServerWork(1, () -> {
                  if (world instanceof Level) {
                     ...
                     if (!_level.m_5776_()) {
                        _level.m_5594_((Player)null, BlockPos.m_274561_(x, y, z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:riflemagazine")), SoundSource.NEUTRAL, 1.0F, 1.0F);
                     } else {
                        _level.m_7785_(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:riflemagazine")), SoundSource.NEUTRAL, 1.0F, 1.0F, false);
                     }
                  }
               ...
               if (var10000.m_41720_() instanceof SemiAutomaticRifleAnimatedItem) {
                  ...
                  var10000.m_41784_().m_128359_("geckoAnim", "MagOut");
               }
            ...
            if (var10000.m_41720_() == CrustyChunksModItems.MEDIUM_MAGAZINE.get()) {
               if (entity instanceof LivingEntity) {
                  _livEnt = (LivingEntity)entity;
                  var10001 = _livEnt.m_21205_();
               } else {
               ...
               if (!var10001.m_41784_().m_128471_("Loaded")) {
                  ...
                  if (var10000.m_41720_() instanceof SemiAutomaticRifleAnimatedItem) {
                     ...
                     var10000.m_41784_().m_128359_("geckoAnim", "MagIn");
                  }
         ...
         if (var10001.m_41784_().m_128471_("Loaded")) {
            ...
            if (var10000.m_41720_() == CrustyChunksModItems.MEDIUM_MAGAZINE.get() && entity instanceof Player) {
