      ...
      if (entity != null) {
         if (entity.getPersistentData().m_128459_("Rocket") < 28.0D) {
            ...
            if (!projectileLevel.m_5776_()) {
               ...
               _entityToSpawn.m_6686_(entity.m_20154_().f_82479_, entity.m_20154_().f_82480_, entity.m_20154_().f_82481_, 5.0F, 1.0F);
               projectileLevel.m_7967_(_entityToSpawn);
            }

            entity.getPersistentData().m_128347_("T", (double)Mth.m_216271_(RandomSource.m_216327_(), 5, 7));
