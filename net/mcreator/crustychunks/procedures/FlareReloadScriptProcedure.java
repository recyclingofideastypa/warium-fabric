         ...
         if (var10000.m_41613_() == 0) {
            ...
            if (var10000.m_41720_() == CrustyChunksModItems.FLARE_CHARGE.get()) {
               ...
               if (!var10001.m_41784_().m_128471_("Loaded")) {
                  ...
                  if (var10000.m_41720_() instanceof FlarePistolItem) {
                     if (entity instanceof LivingEntity) {
                        _livEnt = (LivingEntity)entity;
                        var10000 = _livEnt.m_21205_();
                     } else {
                     ...
                     var10000.m_41784_().m_128359_("geckoAnim", "load");
                  }

                  if (world instanceof Level) {
                     _level = (Level)world;
                     if (!_level.m_5776_()) {
                        _level.m_5594_((Player)null, BlockPos.m_274561_(x, y, z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:revolver")), SoundSource.NEUTRAL, 1.0F, 0.8F);
                     } else {
                        _level.m_7785_(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("crusty_chunks:revolver")), SoundSource.NEUTRAL, 1.0F, 0.8F, false);
                     }
                  }
                  ...
                  if (entity instanceof Player) {
                     ...
                     var17.m_41524_(var10001.m_41720_(), 20);
                  }
