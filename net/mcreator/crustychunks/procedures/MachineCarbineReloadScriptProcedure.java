      ...
      if (entity != null) {
         ...
         if (var10000.m_41613_() == 0) {
            ...
            if (var10001.m_41784_().m_128471_("Loaded")) {
               if (entity instanceof LivingEntity) {
                  _livEnt = (LivingEntity)entity;
                  _setstack = (new ItemStack((ItemLike)CrustyChunksModItems.SMG_MAGAZINE.get())).m_41777_();
               ...
               var22.m_128347_("Ammo", var10002.m_41784_().m_128459_("Ammo"));
               if (entity instanceof LivingEntity) {
                  _livEnt = (LivingEntity)entity;
               ...
               var22.m_128359_("Type", var10002.m_41784_().m_128461_("Type"));
               if (entity instanceof LivingEntity) {
                  _livEnt = (LivingEntity)entity;
                  var10000 = _livEnt.m_21205_();
               } else {
            ...
            if (var10000.m_41720_() == CrustyChunksModItems.SMG_MAGAZINE.get()) {
               if (entity instanceof LivingEntity) {
                  _livEnt = (LivingEntity)entity;
                  var10001 = _livEnt.m_21205_();
               } else {
         ...
         if (var10001.m_41784_().m_128471_("Loaded")) {
            ...
            if (var10000.m_41720_() == CrustyChunksModItems.SMG_MAGAZINE.get() && entity instanceof Player) {
