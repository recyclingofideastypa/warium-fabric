...
public class MeltdownProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z) {
      if (world instanceof ServerLevel) {
         ...
         _level.m_8767_(ParticleTypes.f_123783_, x + 0.5D, y + 3.0D, z + 0.5D, 90, 5.0D, 3.0D, 5.0D, 0.0D);
      }
      ...
      while(var9.hasNext()) {
         ...
         entityiterator.getPersistentData().m_128347_("Radiation", entityiterator.getPersistentData().m_128459_("Radiation") + 25.0D);
      ...
      world.m_7731_(BlockPos.m_274561_(x, y, z), ((Block)CrustyChunksModBlocks.RADIOACTIVE_ASH.get()).m_49966_(), 3);
   }
}
