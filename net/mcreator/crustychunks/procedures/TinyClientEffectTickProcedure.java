      ...
      if (immediatesourceentity != null) {
         ...
         if (!immediatesourceentity.getPersistentData().m_128471_("Used")) {
            for(int index0 = 0; index0 < 15; ++index0) {
               world.m_7106_((SimpleParticleType)CrustyChunksModParticleTypes.SMOKE.get(), x, y, z, Mth.m_216263_(RandomSource.m_216327_(), -0.6D, 0.6D), Mth.m_216263_(RandomSource.m_216327_(), -1.0D, 0.5D), Mth.m_216263_(RandomSource.m_216327_(), -0.6D, 0.6D));
            }
