   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         ...
         if (entity instanceof StrikerEntity) {
            for(index16 = 0; index16 < Mth.m_216271_(RandomSource.m_216327_(), 0, 6); ++index16) {
            ...
            for(index16 = 0; index16 < Mth.m_216271_(RandomSource.m_216327_(), 0, 1); ++index16) {
               if (world instanceof ServerLevel) {
                  _level = (ServerLevel)world;
            ...
            if (1 == Mth.m_216271_(RandomSource.m_216327_(), 1, 20) && world instanceof ServerLevel) {
               _level = (ServerLevel)world;
            ...
            for(index16 = 0; index16 < Mth.m_216271_(RandomSource.m_216327_(), 1, 2); ++index16) {
               if (world instanceof ServerLevel) {
                  _level = (ServerLevel)world;
                  entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack((ItemLike)CrustyChunksModItems.STEEL_COMPONENT.get()));
                  entityToSpawn.m_32010_(10);
            ...
            if (1 == Mth.m_216271_(RandomSource.m_216327_(), 1, 10) && world instanceof ServerLevel) {
               _level = (ServerLevel)world;
