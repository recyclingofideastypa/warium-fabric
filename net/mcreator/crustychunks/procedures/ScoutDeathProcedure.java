...
public class ScoutDeathProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         ...
         int index1;
         for(index1 = 0; index1 < Mth.m_216271_(RandomSource.m_216327_(), 0, 3); ++index1) {
         ...
         for(index1 = 0; index1 < Mth.m_216271_(RandomSource.m_216327_(), 0, 1); ++index1) {
            if (world instanceof ServerLevel) {
               _level = (ServerLevel)world;
         ...
         if (world instanceof ServerLevel) {
            _level = (ServerLevel)world;
            _level.m_8767_((SimpleParticleType)CrustyChunksModParticleTypes.HUGE_SPARKS.get(), x, y + 1.0D, z, 25, 0.0D, 0.0D, 0.0D, 0.5D);
         }
