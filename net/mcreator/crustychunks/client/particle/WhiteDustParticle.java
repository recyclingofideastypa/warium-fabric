...
public class WhiteDustParticle extends TextureSheetParticle {
   ...
   protected WhiteDustParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
      ...
      this.m_107250_(0.3F, 1.0F);
      this.f_107663_ *= 10.0F;
      this.f_107225_ = Math.max(1, 100 + (this.f_107223_.m_188503_(20) - 10));
      this.f_107226_ = 0.2F;
      this.f_107219_ = true;
      this.f_107215_ = vx * 0.05D;
      this.f_107216_ = vy * 0.05D;
      this.f_107217_ = vz * 0.05D;
