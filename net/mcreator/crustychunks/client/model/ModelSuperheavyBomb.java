...
public class ModelSuperheavyBomb<T extends Entity> extends EntityModel<T> {
   ...
   public ModelSuperheavyBomb(ModelPart root) {
      ...
      this.Warhead = this.bone.m_171324_("Warhead");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      bone.m_171599_("CoreAddition", CubeListBuilder.m_171558_().m_171514_(58, 65).m_171488_(-12.0F, -12.0F, 0.0F, 12.0F, 12.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.m_171419_(6.0F, -2.0F, -24.0F));
      bone.m_171599_("Warhead", CubeListBuilder.m_171558_().m_171514_(2, 67).m_171488_(-9.0F, -9.0F, 2.0F, 12.0F, 12.0F, 14.0F, new CubeDeformation(0.0F)).m_171514_(2, 93).m_171488_(-6.0F, -6.0F, 0.0F, 6.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.m_171419_(3.0F, -5.0F, -40.0F));
      bone.m_171599_("Fins", CubeListBuilder.m_171558_().m_171514_(0, 28).m_171488_(-7.0F, 2.0F, -2.0F, 12.0F, 12.0F, 13.0F, new CubeDeformation(0.0F)).m_171514_(0, 53).m_171488_(-5.0F, 4.0F, 10.0F, 8.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).m_171514_(50, 28).m_171488_(-9.0F, 7.0F, 0.0F, 4.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)).m_171514_(50, 28).m_171488_(3.0F, 7.0F, 0.0F, 4.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)).m_171514_(50, 44).m_171488_(-2.0F, 12.0F, 0.0F, 2.0F, 4.0F, 14.0F, new CubeDeformation(0.0F)).m_171514_(50, 44).m_171488_(-2.0F, 0.0F, 0.0F, 2.0F, 4.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.m_171419_(1.0F, -16.0F, 10.0F));
