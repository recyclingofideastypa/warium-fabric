...
public class Modelheavybomb<T extends Entity> extends EntityModel<T> {
   ...
   public Modelheavybomb(ModelPart root) {
      this.Munition = root.m_171324_("Munition");
      this.Warhead = this.Munition.m_171324_("Warhead");
      this.Fins = this.Munition.m_171324_("Fins");
      this.Core = this.Munition.m_171324_("Core");
   }

   public static LayerDefinition createBodyLayer() {
      MeshDefinition meshdefinition = new MeshDefinition();
      PartDefinition partdefinition = meshdefinition.m_171576_();
      PartDefinition Munition = partdefinition.m_171599_("Munition", CubeListBuilder.m_171558_(), PartPose.m_171423_(-1.0F, 21.0F, -6.0F, -1.5708F, 0.0F, 0.0F));
      Munition.m_171599_("Warhead", CubeListBuilder.m_171558_().m_171514_(2, 67).m_171488_(-9.0F, -9.0F, 2.0F, 12.0F, 12.0F, 14.0F, new CubeDeformation(0.0F)).m_171514_(2, 93).m_171488_(-6.0F, -6.0F, 0.0F, 6.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.m_171419_(4.0F, -3.0F, -21.0F));
      Munition.m_171599_("Fins", CubeListBuilder.m_171558_().m_171514_(0, 28).m_171488_(-7.0F, 2.0F, -2.0F, 12.0F, 12.0F, 13.0F, new CubeDeformation(0.0F)).m_171514_(0, 53).m_171488_(-5.0F, 4.0F, 10.0F, 8.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).m_171514_(50, 28).m_171488_(-9.0F, 7.0F, 0.0F, 4.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)).m_171514_(50, 28).m_171488_(3.0F, 7.0F, 0.0F, 4.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)).m_171514_(50, 44).m_171488_(-2.0F, 12.0F, 0.0F, 2.0F, 4.0F, 14.0F, new CubeDeformation(0.0F)).m_171514_(50, 44).m_171488_(-2.0F, 0.0F, 0.0F, 2.0F, 4.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.m_171419_(2.0F, -14.0F, 13.0F));
      Munition.m_171599_("Core", CubeListBuilder.m_171558_().m_171514_(0, 0).m_171488_(-5.0F, -12.0F, -5.0F, 12.0F, 12.0F, 16.0F, new CubeDeformation(0.0F)).m_171514_(24, 53).m_171488_(0.0F, -14.0F, 0.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).m_171514_(56, 0).m_171488_(0.0F, 0.0F, 0.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.m_171419_(0.0F, 0.0F, 0.0F));
   ...
   public void m_7695_(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      this.Munition.m_104306_(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
   }
}
