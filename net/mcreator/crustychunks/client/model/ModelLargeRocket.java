...
public class ModelLargeRocket<T extends Entity> extends EntityModel<T> {
   ...
   public ModelLargeRocket(ModelPart root) {
      ...
      this.Core = this.Rocket.m_171324_("Core");
      this.Warhead = this.Rocket.m_171324_("Warhead");
