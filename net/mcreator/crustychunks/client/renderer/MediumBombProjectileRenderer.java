...
public class MediumBombProjectileRenderer extends EntityRenderer<MediumBombProjectileEntity> {
   private static final ResourceLocation texture = new ResourceLocation("crusty_chunks:textures/entities/mediumbombtextureentity.png");
   private final ModelMediumBomb_Converted model;

   public MediumBombProjectileRenderer(Context context) {
      super(context);
      this.model = new ModelMediumBomb_Converted(context.m_174023_(ModelMediumBomb_Converted.LAYER_LOCATION));
   }
