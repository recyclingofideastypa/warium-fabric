...
public class BlastFurnaceGUIScreen extends AbstractContainerScreen<BlastFurnaceGUIMenu> {
   ...
   protected void m_7286_(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
      ...
      guiGraphics.m_280163_(new ResourceLocation("crusty_chunks:textures/screens/graydust.png"), this.f_97735_ + 7, this.f_97736_ + 35, 0.0F, 0.0F, 16, 16, 16, 16);
      guiGraphics.m_280163_(new ResourceLocation("crusty_chunks:textures/screens/graydust.png"), this.f_97735_ + 7, this.f_97736_ + 62, 0.0F, 0.0F, 16, 16, 16, 16);
      guiGraphics.m_280163_(new ResourceLocation("crusty_chunks:textures/screens/grayingot.png"), this.f_97735_ + 151, this.f_97736_ + 35, 0.0F, 0.0F, 16, 16, 16, 16);
   ...
   protected void m_280003_(GuiGraphics guiGraphics, int mouseX, int mouseY) {
      guiGraphics.m_280614_(this.f_96547_, Component.m_237115_("gui.crusty_chunks.blast_furnace_gui.label_blastfurnace"), 105, 7, -12829636, false);
   }
