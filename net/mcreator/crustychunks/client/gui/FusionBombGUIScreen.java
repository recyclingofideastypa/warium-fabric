...
public class FusionBombGUIScreen extends AbstractContainerScreen<FusionBombGUIMenu> {
   ...
   protected void m_7286_(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
      ...
      guiGraphics.m_280163_(new ResourceLocation("crusty_chunks:textures/screens/grayimpactfuse.png"), this.f_97735_ + 151, this.f_97736_ + 8, 0.0F, 0.0F, 16, 16, 16, 16);
      ...
      guiGraphics.m_280163_(new ResourceLocation("crusty_chunks:textures/screens/fusioncore.png"), this.f_97735_ + 151, this.f_97736_ + 35, 0.0F, 0.0F, 16, 16, 16, 16);
   ...
   protected void m_280003_(GuiGraphics guiGraphics, int mouseX, int mouseY) {
      guiGraphics.m_280614_(this.f_96547_, Component.m_237115_("gui.crusty_chunks.fusion_bomb_gui.label_fission_bomb"), 6, 7, -12829636, false);
   }
